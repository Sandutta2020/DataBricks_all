...
# MAGIC
# MAGIC Let's create the confusion matrix and [**log it with MLflow** using **`log_figure`** function](https://mlflow.org/docs/2.20.3/traditional-ml/hyperparameter-tuning-with-child-runs/part2-logging-plots.html?highlight=log_figure ). This function logs in-memory figure objects directly to the current run.
...
# MAGIC
# MAGIC   **Option 1:**
# MAGIC   - Click the Experiment icon<img src= "https://files.training.databricks.com/binder/prod_main/machine-learning-model-development-en_us-3.0.2/images/20260904T110216Z/Includes/images/experiment.png" width=30>in the notebook’s right sidebar
# MAGIC
# MAGIC   - In the Experiment Runs sidebar, click the<img src= "https://files.training.databricks.com/binder/prod_main/machine-learning-model-development-en_us-3.0.2/images/20260904T110216Z/Includes/images/external-link.png" width=30>icon next to the date of the run. The MLflow Run page displays, showing details of the run, including parameters, metrics, tags, and a list of artifacts.
# MAGIC
# MAGIC     ![quick-start-nb-experiment](https://files.training.databricks.com/binder/prod_main/machine-learning-model-development-en_us-3.0.2/images/20260904T110216Z/Includes/images/quick-start-nb-experiment1.png)
# MAGIC
# MAGIC   **Option 2:**
# MAGIC   - Click on **Experiments** in the left sidebar.
...
# MAGIC
# MAGIC + **Step 2: Reviewing Artifacts and Metrics:**
# MAGIC
# MAGIC   - Click on the run to see detailed information.
# MAGIC   - Navigate to the "Artifacts" tab to view logged artifacts.
# MAGIC   - Navigate to the "Model metrics" tab to view logged metrics.
# MAGIC
# MAGIC + **Step 3: Viewing Confusion Matrix Image:**
# MAGIC
...
# MAGIC
# MAGIC + **Step 4: View models in the UI:**
# MAGIC   - You can find details about the logged model under the<img src= "https://files.training.databricks.com/binder/prod_main/machine-learning-model-development-en_us-3.0.2/images/20260904T110216Z/Includes/images/models-icon.png" width=30>**Models** tab.
