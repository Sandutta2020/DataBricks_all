...
# MAGIC This SDP pipeline is a simple example pipeline that includes a few integration checks using expectations on a simple project to teach the basics. There are additional expectations you can set or unit tests you can build to streamline the project, but we're keeping it simple.
# MAGIC
...
# MAGIC This path will use the configuration variable set in the SDP pipeline for **development, stage and production**.
# MAGIC
