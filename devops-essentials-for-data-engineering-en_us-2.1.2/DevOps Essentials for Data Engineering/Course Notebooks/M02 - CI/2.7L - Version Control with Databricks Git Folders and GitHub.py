...
# MAGIC     ```
# MAGIC
# MAGIC 3. At the top of the file, next to the file name **README.md**, you’ll see your repo branch name, **main**.
# MAGIC
...
# MAGIC At the end of this lab you should delete your PAT you created in this lab from your GitHub account. 
# MAGIC
# MAGIC However, when this lab ends, this Vocareum lab account will be cleared.
