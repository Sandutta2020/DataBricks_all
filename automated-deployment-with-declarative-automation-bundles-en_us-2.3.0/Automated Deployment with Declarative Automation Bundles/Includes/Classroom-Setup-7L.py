...
class MLModelHandler:
    def __init__(self):
        self.catalog_name = f'{my_catalog}'
        self.schema_name = 'default'
        self.username = my_catalog
        self.env = '_1_dev'
        self.csv_file_path = f'/Volumes/{my_catalog}_3_prod/default/health/2025-01-02_health.csv'
    ...
    def transform_cleaned_data(self, cleaned_df):
        transformed_df = (
            ...
            .withColumn("Age", when(col("Age") == "null", None).otherwise(col("Age")))
            .withColumn("log_Age", log(col("Age").cast("double") + 1))
    ...
    def create_features(self, transformed_df):
        ...
        feature_df = (
            ...
            .withColumn("Age", col("Age").cast("double").cast("int"))
        )
