...
# MAGIC   <strong style="color: #0d47a1;">Step-by-step — Genie Code:</strong>
# MAGIC   <ol style="margin: 8px 0 0 18px; color: #333; line-height: 1.8;">
# MAGIC     <li>Click the <strong>Genie</strong> icon on the right-hand panel of your notebook.</li>
# MAGIC     <li>Agent Mode is enabled by default. Genie Code can read notebook state, insert and execute cells, and reason across tool calls.</li>
