...
# MAGIC %md
# MAGIC ## Course-specific inputs

# COMMAND ----------

# Change the course name as per your course name
COURSE_NAME = "Machine Learning Model Development"
RUN_QA_CHECKER = True
...
TESTER_EMAILS = [
    "gaganpreet.kaur@databricks.com",
    "s.kumar@databricks.com"
]

# Add your lab notebook paths relative from the CourseRunner folder as per your course
LAB_NOTEBOOKS = [
    "../../M01 - Model Development Workflow/1.4 Lab - Model Development Tracking with MLflow",
    "../../M02 - Hyperparameter Tuning/2.3 Lab - Hyperparameter Tuning with Optuna",
    "../../M03 - Agentic Machine Learning/3.3 Lab - Agentic ML with Genie Code",
]

# Define the course notebook DAG here so this can be used for job scheduling as per your course
COURSE_TASKS = [
    {
        "task_key": "1.2a Demo - Supervised Learning",
        "name": "1.2a Demo - Supervised Learning",
        "relative_path": "../../M01 - Model Development Workflow/1.2a Demo - Supervised Learning",
        "depends_on": [],
        "env_key": "course_01",
        "use_classic": True,
    },
    {
        "task_key": "1.2b Demo - Unsupervised Learning",
        "depends_on": [
            {"task_key": "1.2a Demo - Supervised Learning"},
        ],
        "name": "1.2b Demo - Unsupervised Learning",
        "relative_path": "../../M01 - Model Development Workflow/1.2b Demo - Unsupervised Learning",
        "env_key": "course_01b",
        "use_classic": True,
    },
    {
        "task_key": "1.3 Demo - Model Tracking with MLflow",
        "depends_on": [
            {"task_key": "1.2b Demo - Unsupervised Learning"},
        ],
        "name": "1.3 Demo - Model Tracking with MLflow",
        "relative_path": "../../M01 - Model Development Workflow/1.3 Demo - Model Tracking with MLflow",
        "env_key": "course_01c",
        "use_classic": True,
    },
    {
        "task_key": "1.4 Lab - Model Development Tracking with MLflow",
        "depends_on": [
            {"task_key": "1.3 Demo - Model Tracking with MLflow"},
        ],
        "name": "1.4 Lab - Model Development Tracking with MLflow",
        "relative_path": "../../M01 - Model Development Workflow/1.4 Lab - Model Development Tracking with MLflow",
        "env_key": "course_01_lab",
        "use_classic": True,
    },
    {
        "task_key": "2.2 Demo - Hyperparameter Tuning with Optuna",
        "depends_on": [
            {"task_key": "1.4 Lab - Model Development Tracking with MLflow"},
        ],
        "name": "2.2 Demo - Hyperparameter Tuning with Optuna",
        "relative_path": "../../M02 - Hyperparameter Tuning/2.2 Demo - Hyperparameter Tuning with Optuna",
        "env_key": "course_02",
        "use_classic": True,
    },
    {
        "task_key": "2.3 Lab - Hyperparameter Tuning with Optuna",
        "depends_on": [
            {"task_key": "2.2 Demo - Hyperparameter Tuning with Optuna"},
        ],
        "name": "2.3 Lab - Hyperparameter Tuning with Optuna",
        "relative_path": "../../M02 - Hyperparameter Tuning/2.3 Lab - Hyperparameter Tuning with Optuna",
        "env_key": "course_02_lab",
        "use_classic": True,
    },
    {
        "task_key": "3.2 Demo - Model Development with Genie Code",
        "depends_on": [
            {"task_key": "2.3 Lab - Hyperparameter Tuning with Optuna"},
        ],
        "name": "3.2 Demo - Model Development with Genie Code",
        "relative_path": "../../M03 - Agentic Machine Learning/3.2 Demo - Model Development with Genie Code",
        "env_key": "course_03",
        "use_classic": True,
    },
    {
        "task_key": "3.3 Lab - Agentic ML with Genie Code",
        "depends_on": [
            {"task_key": "3.2 Demo - Model Development with Genie Code"},
        ],
        "name": "3.3 Lab - Agentic ML with Genie Code",
        "relative_path": "../../M03 - Agentic Machine Learning/3.3 Lab - Agentic ML with Genie Code",
        "env_key": "course_03_lab",
        "use_classic": True,
    },
]
...
PLACEHOLDER_PATTERNS = [
    ...
    re.compile(r'(?mi)^\s*--\s*TODO\b'),
    # Bare FILL_IN used as a Python identifier (e.g., payments_schema = FILL_IN)
    re.compile(r'\bFILL_IN\b'),
]
...
def extract_solution_from_source(source: str) -> str | None:
    ...
    - HTML <div class="cb"> blocks with <br/> line separators (Databricks Academy format)
    ...
    # 2. Databricks Academy <div class="cb"> format (uses <br/> as line separators)
    match = re.search(r'<div\s+class=["\']cb["\'][^>]*>\s*\n?(.*?)\n?\s*</div>', clean, re.DOTALL)
    if match:
        raw = match.group(1)
...
def is_solution_candidate(cell: dict) -> bool:
    ...
    has_code_block = '```' in source or '<code>' in source or 'class="cb"' in source or "class='cb'" in source
...
def fill_notebook(notebook_path: str) -> dict:
    ...
    for i, cell in enumerate(cells):
        ...
        # Skip %md / %md-sandbox magic cells (they are code type in ipynb but render as markdown)
        if re.match(r'\s*%md', source):
            continue
