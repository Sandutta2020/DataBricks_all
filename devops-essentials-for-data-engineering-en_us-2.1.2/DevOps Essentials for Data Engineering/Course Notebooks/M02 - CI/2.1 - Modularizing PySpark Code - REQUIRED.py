...
# MAGIC
# MAGIC **NOTE:** We will be migrating this ETL pipeline to a Spark Declarative Pipeline later in the project. For the purpose of exploration and development we will read the CSV files with a simple batch read.
# MAGIC
