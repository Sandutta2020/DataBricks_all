...
# MAGIC %md
# MAGIC ### E3. Set the True Condition (Duplicates Exist) Task
# MAGIC
...
# MAGIC
# MAGIC 4. Set the notebook path to [Task Files/Lesson 4 Files/4.5 - For Each: Customer orders State]($./Task Files/Lesson 4 Files/4.5 - For Each: Customer orders State), which is under the **Task Files** folder.
# MAGIC
