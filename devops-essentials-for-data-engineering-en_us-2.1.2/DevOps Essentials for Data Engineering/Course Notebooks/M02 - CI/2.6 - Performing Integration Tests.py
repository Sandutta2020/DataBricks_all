...
# MAGIC
# MAGIC 1. **Lakeflow Spark Declarative Pipeline (Formerly DLT)**: With Lakeflow Spark Declarative Pipelines, you can use expectations to check pipeline’s results.
...
# MAGIC
# MAGIC In this demonstration, we will quickly introduce to you how to perform simple integration tests with Delta Live Tables and discuss how to implement them with Jobs. Prior knowledge of Lakeflow Spark Declarative Pipeline and Lakeflow Jobs is assumed.
# MAGIC
# MAGIC ## Objectives
# MAGIC
# MAGIC - Learn how to perform integration testing in Lakeflow Spark Declarative Pipelines using expectations.
...
# MAGIC %md
# MAGIC ## B. Option 1 - Lakeflow Spark Declarative Pipeline with Integration Tests
# MAGIC
...
# MAGIC
# MAGIC - With Lakeflow Spark Declarative Pipelines, you can use expectations to check pipeline’s results.
# MAGIC   - [Manage data quality with pipeline expectations](https://docs.databricks.com/aws/en/ldp/expectations#manage-data-quality-with-pipeline-expectations)
# MAGIC
...
# MAGIC
# MAGIC     **NOTE:** The Databricks SDK is outside the scope of this course. However, if you're interested in seeing the code that uses the SDK to automate building Lakeflow Spark Declarative Pipelines in Databricks Academy, check out the **[../Includes/Classroom-Setup-Common]($../Includes/Classroom-Setup-Common)** notebook in **Cell 6**.
# MAGIC
...
# MAGIC
# MAGIC
# MAGIC ![Full Lakeflow Spark Declarative Pipeline](../Includes/images/04_dlt_pipeline.png)
...
# MAGIC %md
# MAGIC 2. While the Lakeflow Spark Declarative Pipeline is running, examine it through the UI by completing the following steps:
# MAGIC
...
# MAGIC
# MAGIC   ![Explain SDP Pipeline](../Includes/images/04_sdp_explain_integrations.png)
...
# MAGIC
# MAGIC **NOTE:** We will simply review how to implement integration tests with Jobs if that is the method you prefer. The final deployment for this course uses the Lakeflow Spark Declarative Pipeline integration tests with expectations.
# MAGIC
# MAGIC #### Steps to take:
