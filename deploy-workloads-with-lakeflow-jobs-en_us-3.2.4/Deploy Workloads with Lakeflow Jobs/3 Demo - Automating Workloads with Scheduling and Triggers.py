...
# MAGIC The Task notebook for this demo will need to know the name of the catalog and schema we are working with. We can configure this using **Task parameters** (you can also use **Job Parameters** and it will get pushed down to all tasks). 
# MAGIC
