...
COURSE_NAME = "Machine Learning Model Deployment"
RUN_QA_CHECKER = True
...
LAB_NOTEBOOKS = [
    "../../M02 - Batch Deployment/2.3 Lab - Batch Deployment",
    "../../M04 - Real-time Deployment and Online Stores/4.5 Lab - Real-time Deployment with Model Serving",
]

# Define the course notebook DAG here so this can be used for job scheduling as per your course
COURSE_TASKS = [
    {
        "task_key": "2.2 Demo - Batch Deployment",
        "name": "2.2 Demo - Batch Deployment",
        "relative_path": "../../M02 - Batch Deployment/2.2 Demo - Batch Deployment",
        "depends_on": [],
        "env_key": "course_02",
        "use_classic": True,
    },
    {
        "task_key": "2.3 Lab - Batch Deployment",
        "depends_on": [
            {"task_key": "2.2 Demo - Batch Deployment"},
        ],
        "name": "2.3 Lab - Batch Deployment",
        "relative_path": "../../M02 - Batch Deployment/2.3 Lab - Batch Deployment",
        "env_key": "course_02_lab",
        "use_classic": True,
    },
    {
        "task_key": "3.2 Demo - Pipeline Deployment",
        "depends_on": [
            {"task_key": "2.3 Lab - Batch Deployment"},
        ],
        "name": "3.2 Demo - Pipeline Deployment",
        "relative_path": "../../M03 - Pipeline Deployment/3.2 Demo - Pipeline Deployment",
        "env_key": "course_03",
        "use_classic": True,
    },
    {
        "task_key": "4.3 Demo - Real-time Deployment with Model Serving",
        "depends_on": [
            {"task_key": "3.2 Demo - Pipeline Deployment"},
        ],
        "name": "4.3 Demo - Real-time Deployment with Model Serving",
        "relative_path": "../../M04 - Real-time Deployment and Online Stores/4.3 Demo - Real-time Deployment with Model Serving",
        "env_key": "course_04",
        "use_classic": True,
    },
    {
        "task_key": "4.4 Demo - Custom Model Deployment with Model Serving",
        "depends_on": [
            {"task_key": "4.3 Demo - Real-time Deployment with Model Serving"},
        ],
        "name": "4.4 Demo - Custom Model Deployment with Model Serving",
        "relative_path": "../../M04 - Real-time Deployment and Online Stores/4.4 Demo - Custom Model Deployment with Model Serving",
        "env_key": "course_04b",
        "use_classic": True,
    },
    {
        "task_key": "4.5 Lab - Real-time Deployment with Model Serving",
        "depends_on": [
            {"task_key": "4.4 Demo - Custom Model Deployment with Model Serving"},
        ],
        "name": "4.5 Lab - Real-time Deployment with Model Serving",
        "relative_path": "../../M04 - Real-time Deployment and Online Stores/4.5 Lab - Real-time Deployment with Model Serving",
        "env_key": "course_04_lab",
        "use_classic": True,
    },
]
